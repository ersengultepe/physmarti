                    ...
                    <div class="breadcrumbs-wrap text-center">
                        <ul class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
                            <li class="home" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                                <a itemprop="item" href="<?php echo e(route('homepage')); ?>"
                                    title="Go to Home Page"><span itemprop="name"><?php echo e(__('physmart.homePage')); ?></span></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smarty\resources\views/frontend/pages/products.blade.php ENDPATH**/ ?>