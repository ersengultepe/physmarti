        ...
        <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            <article>
                <div class="row">
                    ...
                    <div class="col ps-1">
                        <h4 class="line-height-3 text-4"><a href="{{ route('phyblogs', ['slug' => $blog->slug]) }}" class="text-dark">{{ $blog->getTranslatedAttribute('title', \Illuminate\Support\Facades\Session::get('locale')) }}</a></h4>
