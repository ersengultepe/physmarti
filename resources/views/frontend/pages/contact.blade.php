                ...
                <div class="col-lg-5">
                    ...
                    <div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">
                        ...
                        <ul class="list list-icons list-icons-style-3 mt-2">
                            <li><i class="fas fa-map-marker-alt top-6"></i> <strong> {{ __('physmart.address') }}:</strong> {!! $contact->address !!}</li>
                            <li><i class="fas fa-phone top-6"></i> <strong> {{ __('physmart.telephone') }}:</strong> {{ $contact->tel }}</li>
                            <li><i class="fas fa-envelope top-6"></i> <strong> {{ __('physmart.email') }}:</strong> <span>{{ $contact->email }}</span> </li>
                        </ul>
    ...
    <script>
        ...
        */
        ...
        var mapMarkers = [{
            ...
            html: "<strong style='font-size: large'>Physmart</strong><br>{{wordwrap($contact->address,75,"\n")}}<br><br><a href='#' onclick='mapCenterAt({latitude: 39.9805522, longitude: 32.7420487, zoom: 14}, event)'>[+]  {{ __('physmart.zoom') }} </a>",
            icon: {
