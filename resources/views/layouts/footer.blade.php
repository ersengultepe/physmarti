                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="list list-icons list-icons-lg">
                            <li class="mb-1"><i class="far fa-dot-circle text-color-primary"></i><p class="m-0">{!! $contact->address !!}</p></li>
                            <li class="mb-1"><i class="fab fa-whatsapp text-color-primary"></i><p class="m-0"><a href="tel:{{ str_replace(' ', '', $contact->tel) }}">{{ $contact->tel }}</a></p></li>
                            <li class="mb-1"><i class="far fa-envelope text-color-primary"></i><p class="m-0"><a href="mailto:{{ $contact->email }}">{{ $contact->email }}</a></p></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
