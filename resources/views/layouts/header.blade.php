                            ...
                            <nav class="header-nav-top">
                                <ul class="nav nav-pills">
                                    <li class="nav-item nav-item-borders py-2 d-none d-sm-inline-flex">
                                        <span class="ps-0"><i class="far fa-dot-circle text-4 text-color-primary" style="top: 1px;"></i> {!! wordwrap($contact->address,75,"<br>\n") !!}</span>
                                    </li>
                                    <li class="nav-item nav-item-borders py-2">
                                        <a href="tel:{{ str_replace(' ', '', $contact->tel) }}"><i class="fab fa-whatsapp text-4 text-color-primary" style="top: 0;"></i> {{ $contact->tel }}</a>
                                    </li>
                                    <li class="nav-item nav-item-borders py-2 d-none d-md-inline-flex">
                                        <a href="mailto:{{ $contact->email }}"><i class="far fa-envelope text-4 text-color-primary" style="top: 1px;"></i> {{ $contact->email }}</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
